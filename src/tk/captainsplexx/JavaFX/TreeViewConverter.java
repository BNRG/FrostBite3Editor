...
public class TreeViewConverter {
	...
	public static final Image boolIcon = new Image(getStream("res/images/document-attribute-bool.png"));
	...
	public static final Image compoundIcon = new Image(getStream("res/images/box.png"));
